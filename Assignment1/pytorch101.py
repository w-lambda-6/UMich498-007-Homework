...
def mutate_tensor(
    ...
    for i in range(len(values)):
        x[indices[i][0], indices[i][0]] = values[i]
    ##########################################################################
    #                            END OF YOUR CODE                            #
    ##########################################################################
    return x
...
def multiples_of_ten(start: int, stop: int) -> Tensor:
    ...
    stop += 1 # stop should be included in the range as well
    el = ceil(start/10)*10
    x = torch.arange(el, stop, 10).to(torch.int64)
    ##########################################################################
    #                            END OF YOUR CODE                            #
    ##########################################################################
    return x
...
def normalize_columns(x: Tensor) -> Tensor:
    ...
    sigma = (((x-mean)**2).sum(0)/(x.shape[0]-1))**0.5
    y = (x-mean)/sigma
    ##########################################################################
    #                            END OF YOUR CODE                            #
    ##########################################################################
